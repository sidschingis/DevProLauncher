...
function c80100032.cfilter(c,tp)
	return c:IsPreviousLocation(LOCATION_MZONE) and c:GetPreviousControler()==tp
		and c:IsReason(REASON_DESTROY) and c:IsSetCard(0x9c)
end
function c80100032.spcon1(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return eg:IsExists(c80100032.cfilter,1,nil,tp) and not eg:IsContains(c)
end
